  ...
  return (
    <div style={{ background: 'var(--cream)', padding: '64px 24px 96px' }}>
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 13, color: '#776B64', marginBottom: 32 }}>Planning tools for brains that don&rsquo;t run on willpower.</p>
        ...
        <p style={S.p}>Two ways: paid digital products in the <Link href="/shop" style={{ color: '#6E51BD', textDecoration: 'underline', textUnderlineOffset: '2px' }}>shop</Link>, and advertising on the blog. The app itself stays free and carries no ads. We don&rsquo;t sell your data, and we don&rsquo;t take sponsored posts dressed up as articles — if we ever recommend a product, it&rsquo;s because it&rsquo;s genuinely useful.</p>
        ...
        <p style={S.p}>Questions, corrections, or something you&rsquo;d like written about? The <Link href="/contact" style={{ color: '#6E51BD', textDecoration: 'underline', textUnderlineOffset: '2px' }}>contact page</Link> has the details — messages get read by a person.</p>
      </div>
    </div>
  )
}
